...
public class SpringBootBackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		emp.setLastName("gottemukkala");
		emp.setEmailId("venkat@gmail.com");
		employeeRespository.save(emp);
		Employee emp2=new Employee();
		emp2.setId(102);
		emp2.setFirstName("venu");
		emp2.setLastName("gottemukkala");
		emp2.setEmailId("venu@gmail.com");
		employeeRespository.save(emp2);
		Employee emp3=new Employee();
		emp3.setId(103);
		emp3.setFirstName("vishnu");
		emp3.setLastName("gottemukkala");
		emp3.setEmailId("vishnu@gmail.com");
